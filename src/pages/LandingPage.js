...
const LandingPage = () => {
  return (
    <div className="px-44 py-20">
      ...
      <h2 className="introduction text-7xl text-red-300 font-display font-bold">
        I like to build things.
      </h2>
      <p className="description text-gray-400 font-body pt-7 pb-12 text-sm w-3/4 text-justify">
