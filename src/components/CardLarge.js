...
const CardLarge = (props, { darkTheme }) => {
  ...
  return (
    <Card
      additionalClasses={
        "sm:mb-44 mb-32 sm:mx-0 mx-8 sm:w-2/3 w-auto xxl transition transform duration-500 hover:scale-105 ease-out sm:pb-0 pb-6"
      }
      darkTheme={darkTheme}
    >
      {showModal ? (
        // <CarouselProjectTwo setShowModal={setShowModal} darkTheme={darkTheme} />
      ...
      <div className="overflow-hidden bg-gray-100 dark:bg-gray-700 dark:bg-opacity-10">
        <img
          ...
          className="transform -rotate-12 origin-top-right"
        />
      </div>
      <div className="sm:h-36 h-full flex lg:flex-row flex-col w-full">
        ...
        <div className="flex flex-col sm:ml-36 ml-6 mt-10 sm:w-2/3 w-auto sm:pb-6 pb-0">
        ...
        <div className="flex lg:justify-end lg:pt-0 pt-20 content-center w-full items-end">
          {props.buttonText && (
            <button
